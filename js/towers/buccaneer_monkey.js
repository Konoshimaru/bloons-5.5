...
export default {
    stats: { name: "Buccaneer Monkey", cost: 500, range: 120, fireRate: 1.5, damage: 1, projectileSpeed: 600, pierce: 2, lifespan: 0.5, desc: "Fires darts from both sides. Must be placed on water.", dmgType: 'sharp', projectileType: 'dart', hitRadius: 18, waterOnly: true },
    upgrades: {
