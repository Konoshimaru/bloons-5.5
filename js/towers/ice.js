...
export default {
    ...
    upgrades: {
        1: [
            ...
            {name:"Super Brittle", cost:28000, stat:"superBrittle", amount:true, desc:"Bloons take huge damage while frozen, while Ice Shards rip through Ceramic Bloons like paper!", cooldownMult: 0.5, extraMods: { moabPermafrost: true }}
        ],
        2: [
        ...
        3: [
            ...
            {name:"Icicles", cost:2750, stat:"icicles", amount:true, desc:"Does bonus damage to MOAB-Class Bloons. Frozen Bloons grow sharp icicles that can pop Bloons that touch them.", cooldownMult: 0.66, extraMods:{moabDmg: 8, icicleDmg: 3, damage: 1}}, 
