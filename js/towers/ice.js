...
export default {
    ...
    upgrades: {
        1: [
            ...
            {name:"Super Brittle", cost:25000, stat:"damage", amount:2, desc:"Frozen bloons take massive extra damage."}
        ],
        2: [
            ...
            {name:"Absolute Zero", cost:25000, stat:"isAbility", amount:true, desc:"Ability: Freezes all bloons for longer.", extraMods:{unlocksAbility:true, abilityName:"Abs Zero", abilityCd:60}}
        ],
        3: [
            {name:"Frost Aura", cost:600, stat:"range", amount:20, desc:"Damages bloons in range over time."},
            {name:"Re-Freezer", cost:800, stat:"slowDuration", amount:2, desc:"Freezes for longer."},
            {name:"Cold Snap", cost:1000, stat:"canHitLead", amount:true, desc:"Can freeze Lead bloons."},
            {name:"Cryo Cannon", cost:3000, desc:"Shoots a continuous beam of ice.", cooldownMult: 0.5},
            {name:"Icicle Impale", cost:30000, stat:"moabDmg", amount:10, desc:"Deals massive damage to MOABs."}
        ]
    },
    ...
    ability(tower, engine) {
        ...
        const duration = tower.upgrades[1] === 5 ? 8.0 : 4.0;
