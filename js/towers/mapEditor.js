...
export const MapEditor = {
    ...
    init() {
        ...
        document.getElementById('editor-new-path').addEventListener('click', () => this.newPath());
        document.getElementById('editor-toggle-curve').addEventListener('click', () => this.toggleCurve());
        ...
        document.getElementById('editor-apply-json').addEventListener('click', () => this.applyJSON());
