...
export default {
    ...
    getMilitaryTree() {
        return [
            ...
            { id: 'elite_mil_training', x: 200, y: 150, parent: 'core', name: 'Elite Military Training', desc: 'All Military Monkeys get +1 pierce to all shots.', cost: '1 KP', req: 'None' },
            { id: 'emergency_unlock', x: 600, y: 150, parent: 'core', name: 'Emergency Unlock', desc: 'Dartling Gunner swivel speed increased by 15%.', cost: '1 KP', req: 'None' },
