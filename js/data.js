...
const _enemyTypes = {
    ...
    6: { color: '#2c3e50', radius: 14, size: 24, speed: 100, nextTier: null, isBlack: true, livesLost: 3, rbe: 11, maxHp: 1, splitsInto: [{tier: 5, count: 2}], blocksDamageType: (d) => d.isExplosion }, 
    7: { color: '#ffffff', radius: 14, size: 24, speed: 110, nextTier: null, isWhite: true, livesLost: 3, rbe: 11, maxHp: 1, splitsInto: [{tier: 5, count: 2}], blocksDamageType: (d) => d.isIce }, 
    8: { color: '#95a5a6', radius: 18, size: 36, speed: 50, nextTier: null, isLead: true, livesLost: 6, rbe: 23, maxHp: 1, splitsInto: [{tier: 6, count: 2}], blocksDamageType: (d) => d.isSharp && !d.canHitLead },
    ...
    13:{ color: '#2c3e50', radius: 70, size: 120, speed: 40, nextTier: null, isMoab: true, livesLost: 154, rbe: 616, maxHp: 200, splitsInto: [{tier: 12, count: 4}], spriteOffsetX: 0, spriteOffsetY: 0 }, 
    14:{ color: '#e74c3c', radius: 90, size: 160, speed: 30, nextTier: null, isMoab: true, livesLost: 791, rbe: 3164, maxHp: 700, splitsInto: [{tier: 13, count: 4}], spriteOffsetX: 0, spriteOffsetY: 0 }, 
    15:{ color: '#27ae60', radius: 110, size: 190, speed: 20, nextTier: null, isMoab: true, livesLost: 4164, rbe: 16656, maxHp: 4000, splitsInto: [{tier: 14, count: 4}], spriteOffsetX: 0, spriteOffsetY: 0 },
    16:{ color: '#2c3e50', radius: 70, size: 120, speed: 110, nextTier: null, isMoab: true, isDDT: true, livesLost: 816, rbe: 816, maxHp: 400, splitsInto: [{tier: 12, count: 4, forceCamo: true, forceRegen: true}], blocksDamageType: (d) => d.isExplosion || d.isSharp, spriteOffsetX: 0, spriteOffsetY: 0 },
    17:{ color: '#e74c3c', radius: 130, size: 190, speed: 15, nextTier: null, isMoab: true, isBAD: true, livesLost: 55760, rbe: 55760, maxHp: 20000, splitsInto: [{tier: 15, count: 2}, {tier: 16, count: 3}], spriteOffsetX: 0, spriteOffsetY: 0 }
};
...
const _waves = [
    ...
    { groups: [ {t:1, c:10, s:0, e:5.1}, {t:2, c:5, s:5.7, e:7.95}, {t:1, c:15, s:9.71, e:16.71} ] },
    { groups: [ {t:1, c:25, s:0, e:12}, {t:2, c:18, s:7.9, e:10.4}, {t:1, c:10, s:14.51, e:17.31} ] },
    { groups: [ {t:2, c:12, s:0, e:5.14}, {t:1, c:5, s:5.7, e:7.98}, {t:2, c:15, s:8.6, e:16.5} ] },
    { groups: [ {t:3, c:4, s:0, e:1.71}, {t:1, c:15, s:5.33, e:10.33}, {t:2, c:15, s:10.8, e:18.7} ] },
    { groups: [ {t:2, c:10, s:0, e:5.14}, {t:3, c:5, s:5.7, e:10.65}, {t:1, c:20, s:11.81, e:22.65}, {t:2, c:10, s:22.81, e:26.8} ] },
    { groups: [ {t:2, c:20, s:0, e:10.84}, {t:3, c:2, s:11.42, e:11.99}, {t:1, c:10, s:14.03, e:16}, {t:3, c:12, s:18.27, e:28.87} ] },
    { groups: [ {t:3, c:30, s:0, e:18.95} ] },
    { groups: [ {t:2, c:60, s:0, e:35}, {t:2, c:20, s:35, e:44}, {t:2, c:22, s:44, e:47.99} ] },
    ...
    { groups: [ {t:13, c:1, s:0, e:0}, {t:4, c:30, s:5, e:20} ] },
    ...
    { groups: [ {t:14, c:1, s:0, e:0}, {t:12, c:20, s:5, e:20} ] },
