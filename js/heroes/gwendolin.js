...
export default {
    ...
    fire(tower, target, damage, dmgType, isCrit, effects) {
        ...
        for(let i=0; i<count; i++) {
            ...
            p.init(spawnX, spawnY, damage, target, 'fire', tower.stats.projectileSpeed, tower.stats.pierce, tower.stats.lifespan, baseAngle, burnEffects, 0, tower, dmgType);
            p.isCrit = isCrit;
        }
    }
};